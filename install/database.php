 ...
 * BASE DE DATOS
 *
 * En este archivo tenemos la base de datos a incluir junto a la instalación del portal
 *
 * @name database.php
...
$sql['f_fotos'] = "CREATE TABLE IF NOT EXISTS `f_fotos` (
...
$sql['f_comentarios'] = "CREATE TABLE IF NOT EXISTS `f_comentarios` (
...
$sql['f_votos'] = "CREATE TABLE IF NOT EXISTS `f_votos` (
...
$sql['p_posts'] = "CREATE TABLE IF NOT EXISTS `p_posts` (
...
$sql['p_borradores'] = "CREATE TABLE IF NOT EXISTS `p_borradores` (
...
$sql['p_categorias'] = "CREATE TABLE IF NOT EXISTS `p_categorias` (
  `cid` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['p_comentarios'] = "CREATE TABLE IF NOT EXISTS `p_comentarios` (
  `cid` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['p_favoritos'] = "CREATE TABLE IF NOT EXISTS `p_favoritos` (
...
$sql['p_votos'] = "CREATE TABLE IF NOT EXISTS `p_votos` (
...
$sql['u_actividad'] = "CREATE TABLE IF NOT EXISTS `u_actividad` (
...
$sql['u_avisos'] = "CREATE TABLE IF NOT EXISTS `u_avisos` (
...
$sql['u_bloqueos'] = "CREATE TABLE IF NOT EXISTS `u_bloqueos` (
  `bid` int(11) NOT NULL AUTO_INCREMENT,
  `b_user` int(11) NOT NULL,
...
$sql['u_follows'] = "CREATE TABLE IF NOT EXISTS `u_follows` (
...
$sql['u_mensajes'] = "CREATE TABLE IF NOT EXISTS `u_mensajes` (
...
$sql['u_miembros'] = "CREATE TABLE IF NOT EXISTS `u_miembros` (
...
$sql['u_nicks'] = "CREATE TABLE IF NOT EXISTS `u_nicks` (
...
$sql['u_monitor'] = "CREATE TABLE IF NOT EXISTS `u_monitor` (
...
$sql['u_muro'] = "CREATE TABLE IF NOT EXISTS `u_muro` (
...
$sql['u_muro_adjuntos'] = "CREATE TABLE IF NOT EXISTS `u_muro_adjuntos` (
...
$sql['u_muro_comentarios'] = "CREATE TABLE IF NOT EXISTS `u_muro_comentarios` (
  `cid` int(11) NOT NULL AUTO_INCREMENT,
  `pub_id` int(11) NOT NULL,
  `c_user` int(11) NOT NULL,
  `c_date` int(10) NOT NULL,
...
$sql['u_muro_likes'] = "CREATE TABLE IF NOT EXISTS `u_muro_likes` (
...
$sql['u_perfil'] = "CREATE TABLE IF NOT EXISTS `u_perfil` (
  `user_id` int(11) NOT NULL,
...
$sql['u_portal'] = "CREATE TABLE IF NOT EXISTS `u_portal` (
  `user_id` int(11) NOT NULL,
...
$sql['u_rangos'] = "CREATE TABLE IF NOT EXISTS `u_rangos` (
...
$sql['u_respuestas'] = "CREATE TABLE IF NOT EXISTS `u_respuestas` (
...
$sql['u_sessions'] = "CREATE TABLE IF NOT EXISTS `u_sessions` (
...
$sql['u_suspension'] = "CREATE TABLE IF NOT EXISTS `u_suspension` (
...
$sql['w_visitas'] = "CREATE TABLE IF NOT EXISTS `w_visitas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['w_afiliados'] = "CREATE TABLE IF NOT EXISTS `w_afiliados` (
...
$sql['w_configuracion'] = "CREATE TABLE IF NOT EXISTS `w_configuracion` (
  `scscript_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`scscript_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;";

$sql['w_denuncias'] = "CREATE TABLE IF NOT EXISTS `w_denuncias` (
...
$sql['w_contacts'] = "CREATE TABLE IF NOT EXISTS `w_contacts` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`user_id` int(11) NOT NULL,
	`user_email` varchar(50) NOT NULL,
...
$sql['w_medallas_assign'] = "CREATE TABLE IF NOT EXISTS `w_medallas_assign` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['w_historial'] = "CREATE TABLE IF NOT EXISTS `w_historial` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['w_noticias'] = "CREATE TABLE IF NOT EXISTS `w_noticias` (
  `not_id` int(11) NOT NULL AUTO_INCREMENT,
...
$sql['w_blacklist'] = "CREATE TABLE IF NOT EXISTS `w_blacklist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(1) NOT NULL,
...
$sql['w_badwords'] = "CREATE TABLE IF NOT EXISTS `w_badwords` (
...
$sql['w_stats'] = "CREATE TABLE IF NOT EXISTS `w_stats` (
...
$sql['w_themes'] = "CREATE TABLE IF NOT EXISTS `w_themes` (
...
/****************************** ahora insertamos los datos en las tablas ******************************************/

$sql['pv_categorias'] = "INSERT INTO `p_categorias` (`cid`, `c_orden`, `c_nombre`, `c_seo`, `c_img`) VALUES
(1, 1, 'Desarrollo web', 'desarrolloweb', 'flash.png'),
(2, 2, 'Links', 'links', 'link.png'),
(3, 3, 'Linux', 'linux', 'linux.png'),
(4, 4, 'Mac', 'mac', 'mac.png'),
(5, 5, 'PlayStation 4', 'play4', 'controller.png'),
(6, 6, 'Smartphones', 'smartphone', 'phone.png'),
(7, 7, 'Windows', 'windows', 'windows.png'),
(8, 8, 'Xbox One', 'xone', 'controller.png')";

$sql['pv_posts'] = "INSERT INTO `p_posts` (`post_id`, `post_user`, `post_category`, `post_title`, `post_body`, `post_date`, `post_tags`, `post_puntos`, `post_hits`,  `post_private`, `post_block_comments`, `post_sponsored`, `post_sticky`, `post_status`) VALUES
(1, 1, 1, 'Bienvenido a Social Comunity', '[align=center][size=18]Este es el primer post de tu web  ;)  [/size][/align]', 0, 'Social Comunity!', 0, 0, 0, 0, 0, 0, 0);";

$sql['wv_configuracion'] = "INSERT INTO `w_configuracion` (`scscript_id`, `titulo`, `slogan`, `url`, `email`, `banner`, `tema_id`, `ads_300`, `ads_468`, `ads_160`, `ads_728`, `ads_search`, `chat_id`, `xat_id`, `c_last_active`, `c_allow_sess_ip`, `c_count_guests`, `c_reg_active`, `c_reg_activate`, `c_reg_rango`, `c_met_welcome`, `c_message_welcome`, `c_fotos_private`, `c_hits_guest`, `c_keep_points`, `c_allow_points`, `c_allow_edad`, `c_max_posts`, `c_max_com`, `c_max_nots`, `c_max_acts`, `c_newr_type`, `c_allow_sump`, `c_allow_firma`, `c_allow_upload`, `c_allow_portal`, `c_allow_live`, `c_see_mod`, `c_stats_cache`, `c_desapprove_post`, `offline`, `offline_message`, `version`, `version_code`) VALUES
(1, 'Social Comunity!', 'La tecnolog&iacute;a es nuestro mundo', '', '', '', 1, '<img src=\"/themes/default/images/ad300.gif\"/>', '<img src=\"/themes/default/images/ad468.png\"/></a>', '<img src=\"/themes/default/images/ad160.gif\"/>', '<img src=\"/themes/default/images/ad728.gif\"/>', '', '', 0, 15, 1, 0, 1, 1, 3, 0, 'Hola [usuario], [welcome] a [b][web][/b].', 0, 0, 0, 0, 18, 50, 50, 99, 99, 0, 0, 1, 0, 1, 1, 0, 0, 0, 0, 'Estamos en mantenimiento', 'Social Comunity v1.0.0', 'social_comunity_1_0');";

$sql['wv_stats'] = "INSERT INTO `wf_stats` (`stats_no`, `stats_max_online`) VALUES (1, 0);";

$sql['wv_themes'] = "INSERT INTO `w_themes` (`tid`, `t_name`, `t_url`, `t_path`, `t_copy`) VALUES
(1, 'Theme Default', '/themes/default', 'default', 'Social Comunity!');";

$sql['uv_rangos'] = "INSERT INTO `u_rangos` (`rango_id`, `r_name`, `r_color`, `r_image`, `r_cant`, `r_allows`, `r_type`) VALUES
...
(3, 'Rookie', '171717', 'new.png', 0, 'a:12:{s:4:\"godp\";s:2:\"on\";s:4:\"gopp\";s:2:\"on\";s:5:\"gopcp\";s:2:\"on\";s:5:\"govpp\";s:2:\"on\";s:5:\"govpn\";s:2:\"on\";s:5:\"goepc\";s:2:\"on\";s:5:\"godpc\";s:2:\"on\";s:4:\"gopf\";s:2:\"on\";s:5:\"gopcf\";s:2:\"on\";s:4:\"goaf\";s:2:\"20\";s:5:\"gopfp\";s:1:\"5\";s:5:\"gopfd\";s:1:\"5\";}', 0)";
